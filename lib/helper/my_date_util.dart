...
class MyDateUtil {
  ...
  //get last messages time(used in chat user card)
  static String getMessageTime(
    ...
    return now.year == sent.year ? '$formattedTime - ${sent.day} ${_getMonth(sent)}':'${sent.day} ${_getMonth(sent)} ${sent.year}';
  }
  ...
  //get formatted last active timeof user in chat screen
